...
source("packages_publi.R")
source("function_publi")
...
predict_trend_all_butterfly_correct <- merge(res_gamm_butterfly_correct[which(res_gamm_butterfly_correct$sci_name_out %in% res_gamm_butterfly$species_name %in% c(grassland_species, woodland_species, woodland_ind_species, wetland_species)),],predict_trend_all_butterfly, by=c("sci_name_out","PLS"),all.x=TRUE)
