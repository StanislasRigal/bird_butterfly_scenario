...
res_gamm_bird_ex[which(res_gamm_bird_ex$PLS=="europe"),] # returns positive effect of non forest environments on abundance (milieu_catopenland = 1.35, milieu_catothers = 1.40, milieu_caturban = 1.24) and a negative effect of temperature (tempspring = -0.37) and landscape diversity (shannon = - 0.23), a positive effect of increase in agricultural cover on trend (year:d_agri = 0.09), protected area (year:protectedarea_perc = 0.05) and a negative effect of increase in landscape diversity on trend (year:d_shannon = -0.06)
...
res_gamm_butterfly_ex[which(res_gamm_butterfly_ex$PLS == "europe"),] # returns negative effect of non forest environments on abundance (milieu_catopenland = 0.63, milieu_catothers = 0.53), rainfall (precspring = -0.16) and a positive effect of primary productivity (drymatter = - 0.26), a positive effect of increaqe intree density on trend (year:d_treedensity = 0.09) and low intensive farmland cover (year:eulandsystem_farmland_low = 0.15)
...
predict_trend_all_butterfly_correct <- merge(res_gamm_butterfly_correct[which(res_gamm_butterfly_correct$species_name %in% c(grassland_species, woodland_species, woodland_ind_species, wetland_species)),],predict_trend_all_butterfly, by=c("species_name","PLS"),all.x=TRUE)
